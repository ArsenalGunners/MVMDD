...
Thanks for the main contributors of the MVMDD Dataset. They are [Zida Liu](https://zidaliu.github.io/), Juan Blanco, [Guohao Lan](https://guohao.netlify.com/) and [Maria Gorlatova](https://maria.gorlatova.com/). This work is supported by [Intelligent Interactive Internet of Things Lab](https://maria.gorlatova.com/), [Duke University](https://www.duke.edu/)
